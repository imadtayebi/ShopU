        ...
        <div class="container mt-4 col-lg-4">
            <div class="card col-sm-10">
                <div class="card-body ">
                    ...
                    <form id="registro" action="cambiarClave" method="POST" accept-charset="utf-8" class="form" role="form">   

                        <div class="form-group text-center">
                            <h3>Cambiar Contraseña</h3>
                        </div>
                        <label>Por favor rellene los datos.</label>
                        <div class="row mb-2">
                            <div class="col-xs-6 col-md-6">
                                <input type="email" name="email" value="" class="form-control input-lg" placeholder="E-mail" required />
                            </div>
                        </div>
                        <input type="password" id="nuevapass" name="nuevapass" value="" class="form-control input-lg mb-2" placeholder="Nueva Clave" pattern="[A-Za-z][A-Za-z0-9]*[0-9][A-Za-z0-9]*" required />
                        <input type="password" id="pass" name="pass" value="" class="form-control input-lg mb-2" placeholder="Clave de acceso" pattern="[A-Za-z][A-Za-z0-9]*[0-9][A-Za-z0-9]*" required /><span class="text-outline-danger" id="passwordvalida" style="font-weight: bold"></span>
                        <input type="password" id="Rpass" name="clave2" value="" class="form-control input-lg mb-2" placeholder="Repite la clave de acceso" pattern="[A-Za-z][A-Za-z0-9]*[0-9][A-Za-z0-9]*" required/>
                        <input class="btn btn-lg btn-info btn-block signup-btn mb-2" value="Enviar" type="submit"/>
                    </form>          
